  ...
  const aggressive: ArenaAccount = {
    ...
    positions: [
      {
        ...
        name: "新易盛",
        shares: 100,
        available_shares: 100, // 昨日买入，今日可卖
        cost_price: 386.0,
        current_price: 417.2,
        market_value: 41720,
        weight_pct: 40.0,
        ...
        holding_days: 2,
        buy_date: "2026-09-07",
        strategy_reason: "CPO光模块龙头，突破前高箱体，主升浪高弹性进攻",
        sector: "CPO光模块",
        beta: 1.48,
      },
      {
        ...
        holding_days: 2,
        buy_date: "2026-09-07",
        strategy_reason: "高阶高多层算力PCB独供龙头，多头量价突破",
        sector: "PCB算力板",
        beta: 1.36,
      },
    ],
    ...
    orders: [
      ...
      },
      {
        ...
        total_cost: 21955.49,
        score: 90.0,
        reason: "算力PCB高景气，量比放大，顺势追击",
      },
    ],
    attribution: {
      stock_selection_pct: 2.45,
      industry_allocation_pct: 1.15,
      timing_pct: 0.55,
      position_sizing_pct: 0.20,
    ...
    risk_metrics: {
      ...
      top_industry: "CPO光模块",
      top_industry_pct: 40.0,
      concentration_top3_pct: 62.2,
    },
  };
