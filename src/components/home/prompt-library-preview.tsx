...
export function PromptLibraryPreview({ items }: PromptLibraryPreviewProps) {
  ...
  return (
    <section className="relative w-full bg-background pt-24 pb-48 overflow-hidden">
      <div 
      ...
      >
        ...
        <div className="mb-16 border-b border-slate-900/10 pb-8 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
        ...
        <div className="flex flex-col relative">
          {items.map((item, index) => (
            <Link 
              ...
              className="archive-row group relative flex flex-col md:flex-row md:items-center justify-between py-8 border-b border-slate-900/5 hover:border-slate-900/20 transition-all duration-500 z-10"
            >
