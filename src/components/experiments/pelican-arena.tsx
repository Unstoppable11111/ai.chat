...
export const MODELS: ModelEntry[] = [
  ...
  },
  {
    ...
    features: ["逆向动力学踏板连杆", "果冻弹性喉囊震颤", "复古风镜与视差破风"],
    critique: "最新生成的标杆级物理动力学表现。双足踏板曲柄实现严格的 360° 圆周闭环踩踏，半透明巨喙喉囊具备极具弹性的微颤动效，配合地面飞掠标线与防风镜光泽，兼备机械严谨度与灵动生命力。",
    defaultBadge: "最佳动力学联动",
  },
  {
    id: "grok",
    name: "Grok",
